...
def main():
        #comment code starting from here to run directly from idle---
	...
	affine_correct_flag= (args["affine_mode"])
        #---comment code until here and uncomment the code below
##      image1_path = 'Path to first image goes here'
##      image2_path = 'Path to second image goes here'
##      image3_path = 'Path to third image goes here'
##	image = cv2.imread(image1_path)
##	arm_spread_image=cv2.imread(image2_path)
##	waist_image = cv2.imread(image3_path)
##	affline_mode_bool = True
##	affine_correct_flag= (affline_mode_bool)
